#!/usr/bin/env node
/* Suite de tests Playwright — lot 5e_C7.1 « Mini-projet : le voyant du hall » (arc « jardin connecté » de 4e).
   ...
   Usage : node tests_5e_C7.mjs [dossier_du_lot] [dossier_captures]                 */
...
const CFG = {
  seq: "sequence_5e_C7_mini-projet-objet.html",
  qcm: "qcm_5e_C7_mini-projet.html",
  cle: "seq_5e_C7_mini_projet",
  captures: "/tmp/captures_5eC7",
  etayages: 2,
  formulations: [
