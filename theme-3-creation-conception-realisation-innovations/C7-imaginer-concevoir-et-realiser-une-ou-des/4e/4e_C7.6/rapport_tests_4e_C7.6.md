# Rapport de tests — 4e_C7.6

Ce rapport ne déclare que des tests **réellement exécutés**, sous Chromium (Playwright), le
30/08/2026.

## QCM — `tests_4e_C7.6_qcm.mjs`

    node tests_4e_C7.6_qcm.mjs qcm_4e_C7.6_le-socle.html "4e_C7.6" "" ../../atelier-cao/tp_4e_socle_assemblage.html
...
- **la répartition par code est mesurée dans la banque**, pas déclarée (30 sur `4e_C7.6`) ;
...
- **aucune bonne réponse détachée par sa longueur** (écart maximal toléré : 8 caractères) et
  écart moyen sous 5 caractères (mesuré : +3.8 caractère) ;
...
| `_outils/fix_r.js` | répartition A/B/C/D = 8/7/7/8, graine 762 |
| `_outils/generer_lexique.py` | 30 notions → `lexique_4e_C7.6.html` |
| `_outils/controle_liens.py` | aucune adresse morte dans les pièces du lot |
| `_outils/controle_couverture.py` | verdict rendu **depuis le dossier de chaque code** (un code peut être cité chez lui et évalué ici) : `4e_C7.6` : ÉVALUÉ 30 question(s) |
