#!/usr/bin/env node
/* Suite de tests Playwright — lot 4e_C7.1 « Jardin connecté — concevoir » (arc « jardin connecté » de 4e).
   ...
   Usage : node tests_4e_C7.mjs [dossier_du_lot] [dossier_captures]                 */
...
const CFG = {
  seq: "sequence_4e_C7_jardin-conception.html",
  qcm: "qcm_4e_C7_jardin-conception.html",
  cle: "seq_4e_C7_jardin_conception",
  captures: "/tmp/captures_4eC7",
  etayages: 3,
  formulations: [
  ...
  /* trois combinaisons DIFFÉRENTES : c'est ce que le verrou exige */
  essaisBanc: [
    { "#simMat": "Carton renforcé", "#simMeteo": "Pluie d'automne" },
    { "#simMat": "Plastique récupéré", "#simMeteo": "Pluie d'automne" },
    { "#simMat": "Bois de palette", "#simMeteo": "Gel de janvier" }
  ],
  reponsesAct0: { "#a0q1": "Plastique récupéré", "#a0q2": "La pluie" }
};
