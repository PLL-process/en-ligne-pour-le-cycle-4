# 📦 Le boîtier de la station — `3e_C7.3`

> Aucun matériau ne tient le cahier des charges. Que fait-on — et qui paie la sortie qu'on choisit ?

**Thème 3 · 3<sup>e</sup> — Choisir un matériau constitutif d’un objet et/ou système technique.** · appui `3e_C4.2` · 2 séances de 90 min (160 min d'activités)

➡ **[Ouvrir la séquence](sequence_3e_C7.3_boitier-de-la-station.html)** — hors ligne, sans installation ni compte.
...
|---|---|
| [`sequence_3e_C7.3_boitier-de-la-station.html`](sequence_3e_C7.3_boitier-de-la-station.html) | la séquence élève, hors ligne, avec le banc |
| [`qcm_3e_C7.3_boitier-de-la-station.html`](qcm_3e_C7.3_boitier-de-la-station.html) | 30 questions — 20 sur `3e_C7.3`, 10 sur `3e_C4.2`, 90 réfutations |
| [`lexique_3e_C7.3.html`](lexique_3e_C7.3.html) | 30 notions, engendrées depuis le QCM |
| [`synthese_eleve_3e_C7.3.html`](synthese_eleve_3e_C7.3.html) | à retenir, imprimable en noir et blanc |
| [`synthese_professeur_3e_C7.3.html`](synthese_professeur_3e_C7.3.html) | le pari, les limites, la grille LSU |
| [`fiche_pedagogique_3e_C7.3.md`](fiche_pedagogique_3e_C7.3.md) | déroulé, versions, sécurité, origine des nombres |
| [`matrice_couverture_3e_C7.3.csv`](matrice_couverture_3e_C7.3.csv) | notion → activité → production → question |
| [`rapport_tests_3e_C7.3.md`](rapport_tests_3e_C7.3.md) | la sortie des deux suites, telle quelle |
| `materiaux.py` · `banc_mat.py` · `tests_3e_C7.3_sequence.mjs` · `tests_3e_C7.3_qcm.mjs` · `reponses_3e_C7.3.json` | de quoi tout rejouer |

**Tests réels : 43/43 sur la séquence, 32/32 sur le QCM.**
