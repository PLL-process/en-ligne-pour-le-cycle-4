# Rapport de tests — 3e_C7.6

Ce rapport ne déclare que des tests **réellement exécutés**, sous Chromium (Playwright), le
30/08/2026.

## QCM — `tests_3e_C7.6_qcm.mjs`

    node tests_3e_C7.6_qcm.mjs qcm_3e_C7.6_le-boitier.html "3e_C7.6" "3e_C7.2" ../../atelier-cao/tp_3e_boitier_etanche.html

**32 / 32.** Ce que la suite vérifie :
...
- **la répartition par code est mesurée dans la banque**, pas déclarée (20 sur `3e_C7.6` · 10 sur `3e_C7.2`) ;
...
- **aucune bonne réponse détachée par sa longueur** (écart maximal toléré : 8 caractères) et
  écart moyen sous 5 caractères (mesuré : +4.9 caractère) ;
...
| `_outils/fix_r.js` | répartition A/B/C/D = 8/7/7/8, graine 763 |
| `_outils/generer_lexique.py` | 30 notions → `lexique_3e_C7.6.html` |
| `_outils/controle_liens.py` | aucune adresse morte dans les pièces du lot |
| `_outils/controle_couverture.py` | verdict rendu **depuis le dossier de chaque code** (un code peut être cité chez lui et évalué ici) : `3e_C7.6` : ÉVALUÉ 20 question(s) · `3e_C7.2` : CITÉ aucune question — évalué ailleurs : qcm_3e_C7.6_le-boitier.html (10) |
