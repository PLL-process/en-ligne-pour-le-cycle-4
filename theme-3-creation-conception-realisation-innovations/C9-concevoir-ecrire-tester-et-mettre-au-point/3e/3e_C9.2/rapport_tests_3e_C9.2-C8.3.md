...
Date : 2026-08-19 · Agent : Fable · Environnement : Chromium headless (Playwright 1.56),
...
## 1. Tests automatisés exécutés — 51/51 réussis
...
- **Poids des médias** : 9 SVG originaux de 3,7 à 8,2 Ko — très sous le seuil de 300 Ko ;
...
- **version 🅰 au labo** : montage réel Grove + téléversement ArduBlock Éducation 1.7
  (les planches de paliers sont des reconstitutions étiquetées ; remplacer par des
  captures du poste réel si souhaité — règles n°70/73) ;
- vérification d'un clic de la version courante d'ArduBlock Éducation (site DuinoEdu
  inaccessible à la vérification automatique le 19/08/2026) ;
...
Aucun test exécuté en échec au moment de la remise (51/51).
